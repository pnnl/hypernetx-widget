...
const nodeHiddenDict = {
  'BM':true, 'BR':false, 'CC':false, 'CH': false, 'CN':true, 'FN':false, 'GP':false, 'JA':false, 'JU':false, 'JV':false, 'MA':false, 'MP':false, 'TH':false
}
const nodeRemovedDict={
  'BM':false, 'BR':false, 'CC':false, 'CH': false, 'CN':true, 'FN':false, 'GP':false, 'JA':false, 'JU':false, 'JV':false, 'MA':false, 'MP':false, 'TH':false
}

const edgeHiddenDict = {
  0:false, 1:false, 2:true , 3:false , 4:false , 5:false , 6:true , 7:false
}
